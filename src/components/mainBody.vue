    ...
    return{
      ...
      projects: [
        ...
        },
        {
          ...
          text: 'This project was assigned during my internship to increase my familiarity with MVC architecture and full stack development. I augmented Splash Clinical\'s internal Patient Recruitment Portal (PRP) by programming a referral site transfer interface that would allow designated managers to transfer specific referrals to a different study site in the backend database, which must then be approved by super managers. Enabling this feature alleviated a portion of the development team\'s workload as well as increased the company\'s productivity and efficiency in patient recruitment.',
          code: '#',
          bName: 'video',
          download: '#'
        }
